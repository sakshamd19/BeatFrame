  ...
  useEffect(() => {
    const fetchProfile = async () => {
      try {
        ...
        setIsSpotifyConnected(!!secretData?.spotify_refresh_token);
        ...
        <form onSubmit={handleSave} className="space-y-12">
          ...
          <div className="bg-[#141414] border border-[#27272a] rounded-xl p-6 md:p-8">
            ...
            <div className="space-y-6">
              ...
              <div className="bg-[#1db954]/5 border border-[#1db954]/20 rounded-lg p-6 flex flex-col sm:flex-row items-center justify-between gap-4 mt-8">
                <div className="text-center sm:text-left">
                  <h3 className="text-white font-bold flex items-center justify-center sm:justify-start gap-2 mb-1">
                  ...
                  <p className="text-sm text-[#9ca3af]">
                    {isSpotifyConnected 
                      ? "Your Spotify account is connected! Your listening activity is visible on your profile."
                      : "Connect your account to show your real-time listening activity on your profile."}
                  </p>
                </div>
                <button
                  type="button"
