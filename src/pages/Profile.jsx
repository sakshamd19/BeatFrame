          ...
          <div className="flex-1 relative z-10 w-full">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-2">
              <div className="flex items-center gap-3 flex-wrap">
                ...
                {profile.spotify_activity?.user ? (
                  <a href={profile.spotify_activity.user.external_urls?.spotify} target="_blank" rel="noopener noreferrer" className="flex items-center gap-1.5 text-xs font-bold px-3 py-1.5 bg-[#1db954]/10 text-[#1db954] border border-[#1db954]/20 rounded-full hover:bg-[#1db954]/20 transition-colors">
                    ...
                    {profile.spotify_activity.user.display_name}
                  </a>
                ) : profile.spotify_url ? (
                  ...
                  <Link to="/settings" className="text-xs font-bold px-4 py-2 bg-[#1db954] hover:bg-[#1ed760] text-black rounded-full transition-colors shadow-lg shadow-[#1db954]/20">
                    Connect Spotify
                  </Link>
                )}
              </div>
