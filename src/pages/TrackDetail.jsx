      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <div className="flex flex-col justify-center min-h-[12rem] md:min-h-[16rem] py-2 flex-1 w-full">
                ...
                <div className="flex flex-wrap items-center justify-center md:justify-start gap-4 w-full">
                  <Link 
                    ...
                    className="inline-flex items-center justify-center px-6 py-3 w-full sm:w-[220px] bg-[#8b5cf6] hover:bg-[#7c3aed] text-white rounded-md font-bold transition-colors shadow-lg shadow-[#8b5cf6]/20 gap-2"
                  >
                  ...
                  {track.external_urls?.spotify && (
                    <a 
                      ...
                      className="inline-flex items-center justify-center px-6 py-3 w-full sm:w-[220px] bg-[#1db954] hover:bg-[#1ed760] text-black rounded-md font-bold transition-colors shadow-lg shadow-[#1db954]/20 gap-2"
                    >
                  ...
                  <a 
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center justify-center px-6 py-3 w-full sm:w-[220px] bg-[#ff0000] hover:bg-[#cc0000] text-white rounded-md font-bold transition-colors shadow-lg shadow-[#ff0000]/20 gap-2"
                  >
                    <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
                  ...
                  {track.preview_url && (
                    <audio controls src={track.preview_url} className="h-12 w-full sm:w-[220px] rounded-md mt-2 md:mt-0" />
                  )}
                </div>
              </div>
        ...
        <div>
          ...
          {loadingReviews ? (
            ...
            <div className="bg-surface1 border border-white/5 rounded-2xl p-8 text-center shadow-lg">
              <p className="text-[#9ca3af] mb-4 text-lg">No reviews yet for this track.</p>
              <Link 
