              ...
              <div className="flex flex-col justify-center py-2 flex-1 w-full text-center md:text-left">
                ...
                <div className="flex flex-wrap items-center justify-center md:justify-start gap-4 mb-8">
                  ...
                  <a 
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center justify-center px-8 py-3 bg-[#fa243c] hover:bg-[#e02036] text-white rounded-full font-bold transition-colors shadow-lg shadow-[#fa243c]/20 gap-2"
                  >
                  ...
                  <a 
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center justify-center px-8 py-3 bg-[#00a8e1] hover:bg-[#0096c9] text-white rounded-full font-bold transition-colors shadow-lg shadow-[#00a8e1]/20 gap-2"
                  >
